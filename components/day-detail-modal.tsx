      ...
      {date && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl max-w-md w-full max-h-[80vh] overflow-hidden flex flex-col"
          >
            ...
            <div className="overflow-y-auto p-5 space-y-2">
              ...
              {!loading && pomos.length === 0 && (
                <div className="text-center text-gray-400 py-8">当天没有番茄记录 🍅</div>
              )}
              {!loading &&
                pomos.map((p) => {
                  ...
                  return (
                    <div
                      key={p.id}
                      className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-slate-800/50 hover:bg-gray-100 dark:hover:bg-slate-800 transition"
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          <div className="text-sm font-medium text-gray-900 dark:text-gray-100 truncate">
                            {p.todo?.title ?? (
                              <span className="text-gray-400 italic">未关联任务</span>
                            )}
                          </div>
